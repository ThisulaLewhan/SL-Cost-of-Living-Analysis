...
- Fuel Price Data – Publicly released price revisions  
- Exchange Rate Data (USD/LKR) – Central Bank of Sri Lanka  

> *Note: Category-wise CPI data (e.g., food and non-food) was not available; therefore, the analysis focuses on overall cost-of-living trends.*
...
## 🔍 Methodology
1. Collected raw economic data from official sources  
2. Cleaned and standardized datasets (date formats, missing values, units)  
3. Conducted trend analysis on CPI, fuel prices, and exchange rates  
4. Examined correlations and time-based patterns  
5. Visualized insights using Power BI dashboards  
...
## 📊 Dashboard Features
- Overall cost of living trend visualization  
- Inflation movement over time  
- Fuel price and exchange rate comparisons  
- Time-based filtering for better analysis  
